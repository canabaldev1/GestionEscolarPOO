 ...
 */
package Vistas.Gui.Formularios.Administrativo;
 ...
 * @author lm-carlos
 */
public class AdministrativoFormulario extends javax.swing.JDialog {

    /**
     * Creates new form AdministrativoFormulario
     */
    private JDatePickerImpl datePickerNacimiento;
    private JDatePickerImpl datePickerIngreso;

    public AdministrativoFormulario(java.awt.Frame parent, boolean modal) {
    ...
    private void buscar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar
        ...
        try {
            ...
            Administrativo administrativoBuscado = administrativoDto.buscar(id);

            // Validación básica
            if (administrativoBuscado == null || administrativoBuscado.getId() == null) {
            ...
            // Llenar campos
            campoNombre.setText(administrativoBuscado.getNombres());
            campoApellido.setText(administrativoBuscado.getApellidos());
            campoPassword.setText(administrativoBuscado.getContrasena());
            campoEmail.setText(administrativoBuscado.getEmail());
            campoDireccion.setText(administrativoBuscado.getDireccion());
            campoTelefono.setText(administrativoBuscado.getTelefono());
            campoProfesion.setText(administrativoBuscado.getProfesion());
            campoNumeroCuenta.setText(administrativoBuscado.getNumeroCuentaBancaria());
            campoBanco.setText(administrativoBuscado.getBancoAsociado());

            selectorTipoCuenta.setSelectedItem(administrativoBuscado.getTipoCuentaBancaria().toString());
            selectorEstado.setSelectedItem(administrativoBuscado.getEstado().toString());

            // Establecer fecha de nacimiento
            LocalDate fechaNacimiento = administrativoBuscado.getFechaNacimiento();
            ...
            LocalDate fechaIngreso = administrativoBuscado.getFechaIngreso();
    ...
    private void agregar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregar
        ...
        try {
            ...
            nuevoAdministrativo.setNombres(campoNombre.getText());
            nuevoAdministrativo.setApellidos(campoApellido.getText());
            nuevoAdministrativo.setContrasena(campoPassword.getText());
            nuevoAdministrativo.setEmail(campoEmail.getText());
            nuevoAdministrativo.setDireccion(campoDireccion.getText());
            nuevoAdministrativo.setTelefono(campoTelefono.getText());
            nuevoAdministrativo.setProfesion(campoProfesion.getText());
            nuevoAdministrativo.setNumeroCuentaBancaria(campoNumeroCuenta.getText());
            nuevoAdministrativo.setBancoAsociado(campoBanco.getText());

            String tipoCuentaSeleccionada = (String) selectorTipoCuenta.getSelectedItem();
            nuevoAdministrativo.setTipoCuentaBancaria(TipoCuenta.valueOf(tipoCuentaSeleccionada));

            String estadoSeleccionada = (String) selectorEstado.getSelectedItem();
            nuevoAdministrativo.setEstado(EstadoEmpleado.valueOf(estadoSeleccionada));
            ...
            nuevoAdministrativo.setFechaNacimiento(fechaNacimiento);
            ...
            nuevoAdministrativo.setFechaIngreso(fechaIngreso);

            AdministrativoDto.guardar(nuevoAdministrativo);

            JOptionPane.showMessageDialog(this, "Administrativo agregado con éxito.");
    ...
    private void editar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editar
        ...
        try {
            ...
            // Validación básica
            if (administrativoBuscado == null || administrativoBuscado.getId() == null) {
                String message = "No se encontró ningún administrativo con ese ID.";
                etiquetaError.setText("<html><body style='width: 180px;'>" + message + "</body></html>");
                return;
            }

            // Actualizar valores
            administrativoBuscado.setNombres(campoNombre.getText());
            administrativoBuscado.setApellidos(campoApellido.getText());
            administrativoBuscado.setContrasena(campoPassword.getText());
            administrativoBuscado.setEmail(campoEmail.getText());
            administrativoBuscado.setDireccion(campoDireccion.getText());
            administrativoBuscado.setTelefono(campoTelefono.getText());
            administrativoBuscado.setProfesion(campoProfesion.getText());
            administrativoBuscado.setNumeroCuentaBancaria(campoNumeroCuenta.getText());
            administrativoBuscado.setBancoAsociado(campoBanco.getText());

            String tipoCuentaSeleccionada = (String) selectorTipoCuenta.getSelectedItem();
            administrativoBuscado.setTipoCuentaBancaria(TipoCuenta.valueOf(tipoCuentaSeleccionada));

            String estadoSeleccionada = (String) selectorEstado.getSelectedItem();
            administrativoBuscado.setEstado(EstadoEmpleado.valueOf(estadoSeleccionada));
            ...
            int dayNacimiento = datePickerNacimiento.getModel().getDay();
            LocalDate fechaNacimiento = LocalDate.of(yearNacimiento, monthNacimiento + 1, dayNacimiento);
            administrativoBuscado.setFechaNacimiento(fechaNacimiento);
            ...
            int dayIngreso = datePickerIngreso.getModel().getDay();
            LocalDate fechaIngreso = LocalDate.of(yearIngreso, monthIngreso + 1, dayIngreso);
            administrativoBuscado.setFechaIngreso(fechaIngreso);

            AdministrativoDto.editar(administrativoBuscado);
    ...
    private void botonListar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonListar
        ...
        AdministrativoTodosFormulario ventana = new AdministrativoTodosFormulario(frame, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrativoFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdministrativoFormulario dialog = new AdministrativoFormulario(new javax.swing.JFrame(), true);
