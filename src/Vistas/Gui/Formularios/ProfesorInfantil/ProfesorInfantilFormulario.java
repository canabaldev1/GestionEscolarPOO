 ...
 * @author lm-carlos
 */
public class ProfesorInfantilFormulario extends javax.swing.JDialog {

    /**
     * Creates new form ProfesorInfantilFormulario
     */
    private JDatePickerImpl datePickerNacimiento;
    private JDatePickerImpl datePickerIngreso;

    public ProfesorInfantilFormulario(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Formulario Profesor Infantil");
    ...
    private void buscar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar
        ...
        try {
            ProfesorInfantilDto profesorInfantilDto = new ProfesorInfantilDto();
            String campoIdTexto = campoId.getText();
            Long id = Long.parseLong(campoIdTexto);

            ProfesorInfantil profesorInfantilBuscado = profesorInfantilDto.buscar(id);

            // Validación básica
            if (profesorInfantilBuscado == null || profesorInfantilBuscado.getId() == null) {
            ...
            // Llenar campos
            campoNombre.setText(profesorInfantilBuscado.getNombres());
            campoApellido.setText(profesorInfantilBuscado.getApellidos());
            campoPassword.setText(profesorInfantilBuscado.getContrasena());
            campoEmail.setText(profesorInfantilBuscado.getEmail());
            campoDireccion.setText(profesorInfantilBuscado.getDireccion());
            campoTelefono.setText(profesorInfantilBuscado.getTelefono());
            campoProfesion.setText(profesorInfantilBuscado.getProfesion());
            campoNumeroCuenta.setText(profesorInfantilBuscado.getNumeroCuentaBancaria());
            campoBanco.setText(profesorInfantilBuscado.getBancoAsociado());

            selectorTipoCuenta.setSelectedItem(profesorInfantilBuscado.getTipoCuentaBancaria().toString());
            selectorEstado.setSelectedItem(profesorInfantilBuscado.getEstado().toString());

            // Establecer fecha de nacimiento
            LocalDate fechaNacimiento = profesorInfantilBuscado.getFechaNacimiento();
            ...
            LocalDate fechaIngreso = profesorInfantilBuscado.getFechaIngreso();
    ...
    private void agregar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregar
        ...
        try {
            ProfesorInfantil nuevoProfesorInfantil = new ProfesorInfantil();

            nuevoProfesorInfantil.setNombres(campoNombre.getText());
            nuevoProfesorInfantil.setApellidos(campoApellido.getText());
            nuevoProfesorInfantil.setContrasena(campoPassword.getText());
            nuevoProfesorInfantil.setEmail(campoEmail.getText());
            nuevoProfesorInfantil.setDireccion(campoDireccion.getText());
            nuevoProfesorInfantil.setTelefono(campoTelefono.getText());
            nuevoProfesorInfantil.setProfesion(campoProfesion.getText());
            nuevoProfesorInfantil.setNumeroCuentaBancaria(campoNumeroCuenta.getText());
            nuevoProfesorInfantil.setBancoAsociado(campoBanco.getText());

            String tipoCuentaSeleccionada = (String) selectorTipoCuenta.getSelectedItem();
            nuevoProfesorInfantil.setTipoCuentaBancaria(TipoCuenta.valueOf(tipoCuentaSeleccionada));

            String estadoSeleccionada = (String) selectorEstado.getSelectedItem();
            nuevoProfesorInfantil.setEstado(EstadoEmpleado.valueOf(estadoSeleccionada));
            ...
            nuevoProfesorInfantil.setFechaNacimiento(fechaNacimiento);
            ...
            nuevoProfesorInfantil.setFechaIngreso(fechaIngreso);

            ProfesorInfantilDto.guardar(nuevoProfesorInfantil);

            JOptionPane.showMessageDialog(this, "ProfesorInfantil agregado con éxito.");
    ...
    private void editar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editar
        ...
        try {
            ...
            // Validación básica
            if (profesorInfantilBuscado == null || profesorInfantilBuscado.getId() == null) {
                String message = "No se encontró ningún profesorInfantil con ese ID.";
                etiquetaError.setText("<html><body style='width: 180px;'>" + message + "</body></html>");
                return;
            }

            // Actualizar valores
            profesorInfantilBuscado.setNombres(campoNombre.getText());
            profesorInfantilBuscado.setApellidos(campoApellido.getText());
            profesorInfantilBuscado.setContrasena(campoPassword.getText());
            profesorInfantilBuscado.setEmail(campoEmail.getText());
            profesorInfantilBuscado.setDireccion(campoDireccion.getText());
            profesorInfantilBuscado.setTelefono(campoTelefono.getText());
            profesorInfantilBuscado.setProfesion(campoProfesion.getText());
            profesorInfantilBuscado.setNumeroCuentaBancaria(campoNumeroCuenta.getText());
            profesorInfantilBuscado.setBancoAsociado(campoBanco.getText());

            String tipoCuentaSeleccionada = (String) selectorTipoCuenta.getSelectedItem();
            profesorInfantilBuscado.setTipoCuentaBancaria(TipoCuenta.valueOf(tipoCuentaSeleccionada));

            String estadoSeleccionada = (String) selectorEstado.getSelectedItem();
            profesorInfantilBuscado.setEstado(EstadoEmpleado.valueOf(estadoSeleccionada));
            ...
            int dayNacimiento = datePickerNacimiento.getModel().getDay();
            LocalDate fechaNacimiento = LocalDate.of(yearNacimiento, monthNacimiento + 1, dayNacimiento);
            profesorInfantilBuscado.setFechaNacimiento(fechaNacimiento);
            ...
            int dayIngreso = datePickerIngreso.getModel().getDay();
            LocalDate fechaIngreso = LocalDate.of(yearIngreso, monthIngreso + 1, dayIngreso);
            profesorInfantilBuscado.setFechaIngreso(fechaIngreso);

            ProfesorInfantilDto.editar(profesorInfantilBuscado);
    ...
    private void eliminar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminar
        ...
        try {
            ...
            // Eliminar
            ProfesorInfantilDto.eliminar(id);
    ...
    private void botonListar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonListar
        ...
        ProfesorInfantilTodosFormulario ventana = new ProfesorInfantilTodosFormulario(frame, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesorInfantilFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProfesorInfantilFormulario dialog = new ProfesorInfantilFormulario(new javax.swing.JFrame(), true);
